...
export const AllInitiatives = () => {
  ...
  useEffect(() => {
    // Зареждаме само ако няма данни или сме сменили режима
  ...
  useEffect(() => {
    ...
    // Apply status filter (only for initiatives)
  ...
  const handleView = (item) => {
    ...
    if (viewMode === 'initiatives') {
      ...
      // За чернови може да направим preview или да отидем на edit
  ...
  const handlePublish = async (draft) => {
    if (window.confirm(t('initiatives.admin.confirmPublishDraft'))) {
      try {
        ...
        notify('error', t('initiatives.admin.publishError'));
      }
    }
  };
    ...
    <div className="all-initiatives-admin">
      ...
      <div className="initiatives-grid-admin">
        {filteredItems.map((item) => (
          <div key={item.id} className="initiative-card-admin">
            ...
            <div className="card-body-admin">
              ...
              <div className="card-footer-admin">
                ...
                <div className="card-actions-admin" ref={dropdownRef}>
                  <button 
