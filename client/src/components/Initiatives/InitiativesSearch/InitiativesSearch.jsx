...
export const InitiativesSearch = ({ initiatives, onFilter }) => {
  ...
  const hasActiveFilters = searchTerm || selectedCategory || selectedStatus || selectedLocation || showActiveOnly;
    ...
    <div className="project-search-container">
      ...
      <div className="search-bar-section">
        ...
        <label className="show-active-checkbox">
          ...
          />
          <span>показвай само активни инициативи</span>
        </label>
      </div>
      ...
      <div className="filter-dropdowns">
        <div className="dropdown-item">
          ...
          >
            <option value="">Области на подкрепа</option>
            {categories.map(category => (
              <option key={category} value={category}>{category}</option>
            ))}
          </select>
          <svg className="dropdown-chevron" width="12" height="8" viewBox="0 0 12 8">
        ...
        <div className="dropdown-item">
          <select 
            ...
            className="filter-dropdown"
          >
            <option value="">Статус на инициативата</option>
            {statuses.map(status => (
      ...
      <div className="results-header">
        <h2 className="results-count">
          {filterInitiatives().length} инициативи в {locations.length} локации
        </h2>
        
        <button 
          className={`show-map-btn ${isMapVisible ? 'active' : ''}`}
