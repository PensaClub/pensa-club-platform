...
export const EditAd = () => {
    ...
    const { regions, subregions, fetchSubregions, fetchTowns, searchCriteria, getAdById, editAd } = useCommunityContext();
        ...
        const loadAdDetails = async () => {
            try {
                ...
                setValues({
                    ...
                    extraFields: {
                        price: adDetails.extraFields?.price || '',
                        eventStartDate: adDetails.extraFields?.eventStartDate ? new Date(adDetails.extraFields.eventStartDate) : null,
                        eventEndDate: adDetails.extraFields?.eventEndDate ? new Date(adDetails.extraFields.eventEndDate) : null,
                    },
    ...
    const {
        ...
        handleImageChange,
        handleRemoveImage
    } = useFormCreate(initialValues, async (formData) => {
                        ...
                        <div className="ad-create-form">
                            <form onSubmit={onSubmit}>
                                ...
                                <div className="button-group">
                                    <button type="submit" className="publish-button">{t('ads.edit')}</button>
