    ...
    >
      ...
      <div className={`video-controls ${showControls || !isPlaying ? 'visible' : 'hidden'}`}>
        ...
        <div className="controls-buttons">
          <button className="control-button" onClick={skipBackward} title="Назад 10 секунди">
            <FontAwesomeIcon icon={faBackward} />
          </button>
          
          <button className="control-button" onClick={togglePlay} title={isPlaying ? "Пауза" : "Пусни"}>
            <FontAwesomeIcon icon={isPlaying ? faPause : faPlay} />
          </button>
          
          <button className="control-button" onClick={skipForward} title="Напред 10 секунди">
            <FontAwesomeIcon icon={faForward} />
          </button>
          
          <div className="volume-container">
            <button className="control-button" onClick={toggleMute} title={isMuted ? "Пусни звука" : "Заглуши"}>
          ...
          <button className="control-button" onClick={fullScreen} title="На цял екран">
