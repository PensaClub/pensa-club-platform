...
const VideoThumbnailGenerator = ({ videoFile, onThumbnailGenerated }) => {
  ...
  return (
    <div className="thumbnail-generator">
      <h4>Създайте миниатюра от видеото</h4>
      ...
      {videoDuration > 0 && (
        <div className="video-timeline">
          ...
          >
            {isProcessing ? (
              <>
                <FontAwesomeIcon icon={faCircleNotch} spin /> Обработка...
              </>
            ) : (
              <>
                <FontAwesomeIcon icon={faCamera} /> Използвай този кадър
              </>
            )}
          </button>
        </div>
      ...
      {thumbnailPreview && (
        <div className="thumbnail-preview">
          <h5>Избран кадър за миниатюра:</h5>
          <div className="preview-image-container">
            <img src={thumbnailPreview} alt="Избран кадър за миниатюра" />
          </div>
          <p className="success-message">
            <span className="success-icon">✓</span> Миниатюрата е готова за качване
          </p>
        </div>
      )}
      ...
      <div className="thumbnail-help">
        <p>
          <FontAwesomeIcon icon={faImage} /> <strong>Как да изберете миниатюра:</strong>
        </p>
        <ol>
          <li>Пуснете видеото или използвайте плъзгача, за да намерите подходящ кадър</li>
          <li>Кликнете паузa, когато стигнете до момент, който искате да използвате</li>
          <li>Натиснете бутона "Използвай този кадър"</li>
          <li>Готово! Кадърът ще бъде използван като миниатюра на видеото</li>
        </ol>
      </div>
    </div>
  );
