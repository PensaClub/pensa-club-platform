...
export const AdminFactCheckSignalModal = ({ signal, modules, onClose, onSave, onDelete, onCreateResponse, onEditResponse, onSendEmail }) => {
        ...
        <div className="afcsm-overlay" onClick={handleBackdropClick}>
            <div className="afcsm-modal">
                ...
                <div className="afcsm-actions">
                    ...
                    {(() => {
                        const relatedModule = signal.relatedModuleId
                            ? modules?.find((m) => m.id === signal.relatedModuleId)
                            : null;
                        const hasNonDraftResponse = relatedModule && relatedModule.status !== 'draft';

                        return hasNonDraftResponse ? (
                            <button
                                className="afcsm-btn afcsm-btn--create-response"
                                onClick={() => onEditResponse(relatedModule)}
                            >
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                                </svg>
                                {t('admin.signalModal.editResponse')}
                            </button>
                        ) : (
                            <button
                                className="afcsm-btn afcsm-btn--create-response"
