...
-   **_articleController_** :
    -   **/article/all** : Retrieves all articles with their main images, sections (including section images), and related article connections. Articles are ordered by publish date (DESC) and sections are ordered by their order value (ASC).
    -   **/article/single/:id** : Retrieves a single article by its ID, including main image, sections (with their images), and related article connections.
    -   **/article/create** : Creates a new article with main image, sections (with optional section images), and article relationships. Example of successful article creation:
        ```json
        {
            "title": "Digital Security for Seniors: A Comprehensive Guide",
            "slug": "digital-security-seniors-guide",
            "summary": "Learn essential digital security practices...",
            "author": "Maria Johnson",
            "publishDate": "2024-04-10T10:00:00.000Z",
            "tags": ["security", "digital-literacy"],
            "mainImage": {
                "type": "image",
                "sources": ["https://example.com/images/security-guide.jpg"],
                "alt": "Senior using laptop safely"
            },
            "sections": [
                {
                    "title": "Safe Online Banking",
                    "content": "Online banking can be secure when...",
                    "order": 1,
                    "sectionImage": {
                        "src": "https://example.com/images/banking.jpg",
                        "alt": "Online banking interface",
                        "caption": "Secure banking portal"
                    }
                }
            ],
            "relatedArticleId": 3,
        ...
        ```
    -   **/article/:id** (PUT) : Updates an existing article, including its main image, sections, and article relationships. Supports:
        -   Updating basic article information (title, slug, summary, etc.)
        -   Updating/creating/deleting the main image
        -   Creating new sections with images
        -   Updating existing sections and their images
        -   Managing article relationships (related, next, previous articles)
    -   **/article/:id** (DELETE) : Deletes an article by its ID, including all associated main images, sections, and section images. Also handles cleanup of article relationships.
