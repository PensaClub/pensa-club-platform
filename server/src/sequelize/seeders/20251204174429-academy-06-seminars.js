...
- По желание - собствен лаптоп`,
        ...
        learning_points: JSON.stringify([
          'Как да създадете Gmail акаунт',
          'Изпращане и получаване на имейли',
          'Прикачване на файлове към съобщения',
          'Организиране на пощата с етикети и филтри'
        ]),
        created_at: new Date(),
        updated_at: new Date(),
      },
...
Носете вашия смартфон - ще работим директно с него!`,
        ...
        cancel_reason: null,
        learning_points: JSON.stringify([
          'Основни настройки на смартфона',
          'Инсталиране и управление на приложения',
          'Правене, изпращане и организиране на снимки',
          'Комуникация чрез Viber и WhatsApp',
...
Няма лектор - всички участваме равноправно!`,
        ...
        cancel_reason: 'Недостатъчен брой регистрирани участници за провеждане на дискусията.',
        learning_points: JSON.stringify([
          'Споделяне на опит с технологиите',
          'Полезни съвети за ежедневна употреба',
          'Откриване на нови начини за използване на устройства'
        ]),
        created_at: new Date(),
        updated_at: new Date(),
      },
