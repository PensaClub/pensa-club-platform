        ...
        await queryInterface.bulkInsert('beneficiaries', [
            {
                project_id: projects[0].id,
                total_count: 4,
                total_amount_distributed: 8500.0,
                currency: 'BGN',
                list: JSON.stringify([
                    {
                        id: 'ben_001',
                        ...
                        age: 74,
                        location: 'София',
                        notes: 'Получи помощ за компютър и интернет връзка',
                    },
                    {
                        id: 'ben_002',
                        firstName: 'Иван',
                        ...
                        age: 68,
                        location: 'София',
                        notes: 'Помощ за обучение по дигитални умения',
                    },
                    {
                        id: 'ben_003',
                        firstName: 'Елена',
                        ...
                        profileImage: '/images/beneficiaries/elena_dimitrova.jpg',
                        ...
                        age: 71,
                        location: 'София',
                        notes: 'Завърши курса по дигитални умения успешно',
                    },
                    {
                        id: 'ben_004',
                        firstName: 'Стоян',
                        lastName: 'Василев',
                        email: 'stoyan.vasilev@example.com',
                        profileImage: '/images/beneficiaries/stoyan_vasilev.jpg',
                        ...
                        age: 66,
                        location: 'София',
                        notes: 'В процес на обучение по дигитални умения',
                    },
                ]),
                created_at: new Date(),
                updated_at: new Date(),
            },
            {
                ...
                total_count: 3,
                total_amount_distributed: 4200.0,
                currency: 'BGN',
                list: JSON.stringify([
                    {
                        id: 'ben_005',
                        ...
                        profileImage: '/images/beneficiaries/anna_todorova.jpg',
                        ...
                        age: 69,
                        location: 'Пловдив',
                        notes: 'Художник - получава материали за рисуване',
                    },
                    {
                        id: 'ben_006',
                        firstName: 'Николай',
                        lastName: 'Стоянов',
                        email: 'nikolay.stoyanov@example.com',
                        profileImage: '/images/beneficiaries/nikolay_stoyanov.jpg',
                        ...
                        age: 72,
                        location: 'Пловдив',
                        notes: 'Скулптор - получава глина и инструменти',
                    },
                    {
                        id: 'ben_007',
                        firstName: 'Румяна',
                        lastName: 'Иванова',
                        email: 'rumyana.ivanova@example.com',
                        profileImage: '/images/beneficiaries/rumyana_ivanova.jpg',
                        amountReceived: 1500.0,
                        ...
                        age: 67,
                        location: 'Пловдив',
                        notes: 'Завърши изложбата успешно',
                    },
                ]),
                created_at: new Date(),
                updated_at: new Date(),
