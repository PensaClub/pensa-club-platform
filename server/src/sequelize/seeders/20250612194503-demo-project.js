...
module.exports = {
    async up(queryInterface, Sequelize) {
            ...
            [
                {
                    ...
                    budget_funded: 32000,
                    budget_goal: 50000,
                    start_date: new Date('2024-05-20T00:00:00Z'),
                    end_date: new Date('2024-06-20T23:59:59Z'),
                    estimated_duration: '12 месеца',
                ...
                },
                {
                    ...
                    budget_funded: 15000,
                    budget_goal: 45000,
                    start_date: new Date('2024-05-25T00:00:00Z'),
                    end_date: new Date('2024-06-25T23:59:59Z'),
                    estimated_duration: '12 месеца',
                    location: JSON.stringify({
        ...
        await queryInterface.bulkInsert('images', [
            {
                ...
                alt: 'Digital Literacy Workshops Logo',
                imageable_id: projects[0].id,
        ...
        await queryInterface.bulkInsert('images', [
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968654.png',
                alt: 'Digital Innovation Fund Logo',
            ...
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968655.png',
                alt: 'Tech Startups Bulgaria Logo',
            ...
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968656.png',
                alt: 'Cultural Heritage Foundation Logo',
            ...
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968657.png',
                alt: 'Art Support Network Logo',
                imageable_id: sponsors[3].id,
                image_link_connection: 'sponsor',
                caption: 'random text for testing',
                created_at: new Date(),
                updated_at: new Date(),
        ...
        await queryInterface.bulkInsert('images', [
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968664.png',
                alt: 'Digital Skills Institute Logo',
            ...
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968665.png',
                alt: 'Senior Tech Alliance Logo',
            ...
            {
                src: 'https://cdn-icons-png.flaticon.com/512/1968/1968667.png',
                alt: 'Creative Aging Network Logo',
                imageable_id: partners[3].id,
                image_link_connection: 'partner',
                caption: 'random text for testing',
                created_at: new Date(),
                updated_at: new Date(),
