    ...
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('projects', [
            // Projects for Initiative 1 (Pensa Club)
            {
                ...
                link: '/projects/digital-platform',
                lat: 42.6951,
                lng: 23.3274,
                initiative_id: initiatives[0].id,
                createdAt: new Date(),
            ...
            },
            {
                ...
                link: '/projects/bosch-partnership',
                lat: 42.7025,
                lng: 23.3156,
                initiative_id: initiatives[0].id,
                createdAt: new Date(),
            ...
            // Projects for Healthy Aging Program
            {
                ...
                title: 'Общностни градини за здраве',
                description: 'Създаване на градини за физическа активност и здравословно хранене.',
                status: 'active',
                image: '/images/projects/community-garden.jpg',
                link: '/projects/community-gardens',
                lat: 42.6978,
                lng: 23.3217,
                initiative_id: initiatives[1].id,
                createdAt: new Date(),
            ...
            // Projects for Intergenerational Learning
            {
                ...
                description: 'Младежи обучават възрастни хора на дигитални умения.',
                status: 'active',
                image: '/images/projects/tech-mentoring.jpg',
                link: '/projects/tech-mentoring',
                lat: 42.6995,
                lng: 23.3245,
                initiative_id: initiatives[2].id,
                createdAt: new Date(),
            ...
            // Projects for Digital Literacy
            {
                ...
                description: 'Предоставяне на таблети на възрастни хора за обучение.',
                status: 'active',
                image: '/images/projects/tablet-program.jpg',
                link: '/projects/tablet-program',
                lat: 42.7007,
                lng: 23.3267,
                initiative_id: initiatives[3].id,
                createdAt: new Date(),
            ...
            // Projects for Community Gardening
            {
                ...
                title: 'Семена библиотека',
                description: 'Безплатно споделяне на семена за градинарство.',
                status: 'active',
                image: '/images/projects/seed-library.jpg',
                link: '/projects/seed-library',
                lat: 42.7025,
                lng: 23.33,
                initiative_id: initiatives[4].id,
                createdAt: new Date(),
            ...
            // Projects for Senior Buddy System
            {
                ...
                title: 'Приложение за приятели',
                description: 'Мобилно приложение за свързване на възрастни хора с волонтьори.',
                status: 'active',
            ...
            // Projects for Arts & Crafts
            {
                ...
                title: 'Общностен стенопис',
                description: 'Създаване на стенопис с участието на възрастни хора.',
                status: 'active',
                image: '/images/projects/community-mural.jpg',
                link: '/projects/community-mural',
                lat: 42.7061,
                lng: 23.3366,
                initiative_id: initiatives[6].id,
                createdAt: new Date(),
