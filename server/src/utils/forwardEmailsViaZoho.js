    ...
    <html>
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9;">
            <div style="
                ...
                overflow: hidden;
            ">
                <!-- Subject with vertical gradient line, matching "Message:" style -->
...
`;
    ...
    if (!response.ok) {
        ...
        console.error('Zoho error:', errorData);
        if (errorData.data && errorData.data.errorCode === 'INVALID_OAUTHTOKEN') {
            process.env.ZOHO_ACCESS_TOKEN = '';
            return forwardEmailsViaZoho({ name, userEmail, subject, body, toAddresses });
        }
...
module.exports = forwardEmailsViaZoho;
