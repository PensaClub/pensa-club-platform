...
userDetailsController.post('/details', isAuth, async (req, res, next) => {
    ...
    try {
        ...
        const { region, phoneNumber, username, workOptions, skills, interestOptions, firstName, lastName, gender, birthDate, imageURL, firebaseImagePath } =
            req.body;
...
userDetailsController.post('/contact-form', async (req, res, next) => {
    try {
